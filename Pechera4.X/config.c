...
void Config()
{
    ...
    //PortC
    ANSELC = 0; //Entradas analógicas desabilitadas
    TRISCbits.TRISC0 = 0;
    
    //PortD
    ANSELD = 0; //Entradas analógicas deshabilitadas
    TRISD = 192;
    ...
    //INT0
    INTCONbits.INT0IE = 0; //no Habilita la interrupción
    
    //INT2
    INTCON3bits.INT2IP = 1; //Alta prioridad
    INTCON3bits.INT2E = 1; //Habilita la interrución
    ...
    INTCONbits.TMR0IE = 1; //Habilita la interrupción
    
    //Timer 4 (1: PR2 = 177 - 0: PR2 = 133 - Tbajo: 70)
    ...
    PIE5bits.TMR4IE = 1; //Habilita interrupción
    ...
    PIE1bits.CCP1IE = 1; //Habilita la interrupción
    ...
    PIE2bits.CCP2IE = 1; //Habilita la interrupción
    ...
    PIE4bits.CCP3IE = 1; //Habilita la interrupción
    ...
    PIE1bits.SSP1IE = 1; //Habilita la interrupción
    ...
    SPBRG2 = 0xA0;
    SPBRGH2 = 0x01;
    RCSTA2bits.CREN = 0; //Recepcón continua
    ...
    PIE3bits.TX2IE = 1; //Habilita la interrupción

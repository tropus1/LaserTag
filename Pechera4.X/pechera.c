...
//Variables
GameConfig configJuego; //Guarda la configuración del juego
...
unsigned char contByteEL = 0, contBitEL = 1; //Cuenta el byte que se está transmitiendo, cuenta el bit que se está transmitiendo
    ...
    if(PIE5bits.TMR4IE && PIR5bits.TMR4IF) //Transmisión por láser
    {
        ...
        else if(primerosBitsEL == 16)
        {
            ...
            else 
            {
                ...
                if(contBitEL == 0) //Se transmitió un byte
                {
                    contBitEL = 1;
                    contByteEL++;
        ...
        else
        {
            ...
            else
            {
                ...
                PIE5bits.TMR4IE = 0; // Deshabilita la interrupción
                Laser = 0;
            }
        }
        ...
        if(configJuego.Estado == EnJuego)
        {
            ...
            else if(jugador.estado == Vivo)
            {
                ...
                {                    
                    ...
                    PIE5bits.TMR4IE = 1; //Habilita la interrupción
                ...
                if(receptores[0].DatosLRecibidoFlag) //Recepción de datos por entrada 1
                {
                ...
                if(receptores[1].DatosLRecibidoFlag) //Recepción de datos por entrada 2
                {
                ...
                if(receptores[2].DatosLRecibidoFlag) //Recepción de datos por entrada 3
                {

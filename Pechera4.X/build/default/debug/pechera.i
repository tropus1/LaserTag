...
const unsigned char preambulo = 127;
char DatosEL[6];
unsigned char primerosBitsEL = 0;
Bit flancoEL = 1;
unsigned char contByteEL = 0, contBitEL = 1;
unsigned char cantBytesEL = 0;
...
if(DatosEL[contByteEL] & contBitEL)
PR4 = 177;
else
PR4 = 137;
...
if(PORTBbits.RB0 && !jugador.Arma.disparando)
{
TMR4 = 0;
PR4 = 20;
T4CONbits.T4OUTPS = 10;
T4CONbits.T4CKPS = 0;
T4CONbits.TMR4ON = 1;
PIE5bits.TMR4IE = 1;
...
if(receptores[0].DatosLRecibidoFlag)
{
...
if(receptores[1].DatosLRecibidoFlag)
{
...
if(receptores[2].DatosLRecibidoFlag)
{
